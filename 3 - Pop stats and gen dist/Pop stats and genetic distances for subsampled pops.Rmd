...
```{r data}
data_genind <- readRDS("../data/genind/genind_selection_subsamp.RDS")
...
write.csv(Fis_pop, "Fis_subsampling.csv")
...
# write.table(fst$bs_pairwise$Fst, "Outputs/Fst_diveRsity1000boots_subsamp.txt")
# write.table(fst$bs_pairwise$D, "Outputs/D_diveRsity1000boots_subsamp.txt")
# write.table(fst$bs_pairwise$gst, "Outputs/gst_diveRsity1000boots_subsamp.txt")
# write.table(fst$bs_pairwise$Gst, "Outputs/Gst_diveRsity1000boots_subsamp.txt")
# write.table(fst$bs_pairwise$GGst, "Outputs/GGst_diveRsity1000boots_subsamp.txt")

metadatapop_assign <- metadatapop %>% mutate(pop = gsub('\\ ', "", Population))
#define function to read differentation measure from above files
read_diffmeasure <- function(file = "Outputs/Fst_diveRsity1000boots_subsamp.txt"){
...
fst_df_all <- read_diffmeasure("Outputs/Fst_diveRsity1000boots_subsamp.txt")
...
# read measures
D_df_all <- read_diffmeasure("Outputs/D_diveRsity1000boots_subsamp.txt")
Gst_df_all <- read_diffmeasure("Outputs/gst_diveRsity1000boots_subsamp.txt")
