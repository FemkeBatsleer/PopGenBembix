---
title: "Population statistics and pairwise Fst"
...
data_genind_popyear <- readRDS("../data/genind_selection_popyear.RDS")
metadatapop <- read.dbf("../../GIS/Selection population genetics/Population_centroids_selection_collapsedyear.dbf")
metadatapopyear <- read.dbf("../../GIS/Selection population genetics/Populations_centroids_selection_all_Lambert.dbf")
```
...
write.csv(Fis_pop, "FIS-values/Fis_full.csv")
...
# write.table(fst$bs_pairwise$Fst, "Fst_diveRsity1000boots.txt")
# write.table(fst$bs_pairwise$D, "D_diveRsity1000boots.txt")
# write.table(fst$bs_pairwise$gst, "gst_diveRsity1000boots.txt")
# write.table(fst$bs_pairwise$Gst, "Gst_diveRsity1000boots.txt")
# write.table(fst$bs_pairwise$GGst, "GGst_diveRsity1000boots.txt")

metadatapop_assign <- metadatapop %>% mutate(pop = gsub('\\ ', "", Population))
#define function to read differentation measure from above files
read_diffmeasure <- function(file = "Fst_diveRsity1000boots.txt"){
...
fst_df_all <- read_diffmeasure("Fst_diveRsity1000boots.txt")
...
# read measures
D_df_all <- read_diffmeasure("D_diveRsity1000boots.txt")
Gst_df_all <- read_diffmeasure("gst_diveRsity1000boots.txt")
Gkst_df_all <- read_diffmeasure("Gst_diveRsity1000boots.txt")
Gkkst_df_all <- read_diffmeasure("GGst_diveRsity1000boots.txt")
